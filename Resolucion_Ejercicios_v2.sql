--1. Crea el esquema de la BBDD. (CORREGIDO)
	/*Archivo *.png */
--2. Muestra los nombres de todas las películas con una clasificación por edades de ‘Rʼ. (CORREGIDO)
...
--8. Encuentra el título de todas las películas que son ‘PG-13ʼ o tienen una duración mayor a 3 horas en la tabla film. (CORREGIDO)
...
--46. Encuentra todos los actores que no han participado en películas. (CORREGIDO)
SELECT a.first_name,
       a.last_name
FROM actor AS a
LEFT JOIN film_actor AS fa
...
--53. Encuentra el título de las películas que han sido alquiladas por el cliente con el nombre ‘Tammy Sandersʼ y que aún no se han devuelto. Ordena los resultados alfabéticamente por título de película. (CORREGIDO)
...
--58. Encuentra el título de todas las películas que son de la misma categoría que ‘Animationʼ. (CORREGIDO)
SELECT f.title, 
	c.name AS category
FROM film AS f
INNER JOIN film_category AS fc
